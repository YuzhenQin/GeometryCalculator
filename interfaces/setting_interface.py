...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        #     directory=QStandardPaths.writableLocation(QStandardPaths.StandardLocation),
    ...
    def __setQss(self):
        ...
        if theme == 'dark':
            with open(here + "\\setting_interface_dark.qss",
                      encoding='utf-8') as f:
                self.setStyleSheet(f.read())
        else:
            with open(here + "\\setting_interface_light.qss",
                      encoding='utf-8') as f:
                self.setStyleSheet(f.read())
